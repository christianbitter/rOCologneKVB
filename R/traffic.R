traffic <- function(){
  ...
  data_df$paths <- data_df$geometry$paths;
...
#'@description Returns the status of car parks around cologne. (see: http://www.stadt-koeln.de/externe-dienste/open-data/parking-ts.php)
